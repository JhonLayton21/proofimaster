                ...
                <div className="flex flex-col space-y-2 h-full">
                    <div className="border-b border-solid">
                        <div className="flex items-center justify-between pb-6">
                            <h1 className="text-left text-slate-100 hover:text-orange-800 md:text-xl lg:text-2xl xl:text-3xl 2xl:text-4xl font-bold whitespace-nowrap overflow-hidden">
                                <Link to="/">PROOFIMASTER</Link>
                            </h1>
                            <FontAwesomeIcon icon={faBars} className="fa-2x hover:text-orange-800 cursor-pointer" />
                        </div>
