...
const Clientes = ({ clientes }) => {
    return (
        <div className="bentoItem shadow-lg col-span-6 lg:col-span-3 row-span-1 lg:row-span-2 relative rounded-lg overflow-hidden border p-4 flex flex-col items-center justify-center min-h-[400px] alerta-stock">
