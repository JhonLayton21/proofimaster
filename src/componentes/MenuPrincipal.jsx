    ...
    return (
        <>
            <div className="dark:bg-[#242424] bg-[#D3D3D3] col-span-4 md:col-span-3 p-8 min-w-[320px] w-full">
                <div className="flex items-center justify-between bg-gray-100 dark:bg-[#292929] p-4 rounded-md">
                    <div className="flex items-center">
                        <FontAwesomeIcon icon={faSearch} className=" mr-2 fa-xl" />
                        <input type="text" placeholder="Buscar..." className="bg-gray-100 dark:bg-transparent outline-none" />
                    </div>
                    <div className="flex items-center space-x-8">
                        <div className="flex items-center space-x-2 mx-8 cursor-pointer">
                            ...
                            <div>
                                ...
                                <p className="text-base font-medium text-[#757575] dark:text-[#757575]">Entiende la plataforma</p>
                            </div>
                        </div>
                        <div className="flex items-center space-x-2 cursor-pointer">
                            ...
                            <div className="pr-8">
                                ...
                                <p className="text-base font-medium text-[#757575] dark:text-[#757575] text-left">Administrador</p>
                            </div>
                ...
                <div>
                    <h1 className="text-left text-slate-800 dark:text-slate-50 font-bold pt-16">{titulo}</h1>
