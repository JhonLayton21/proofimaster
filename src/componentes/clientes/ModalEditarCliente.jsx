...
const ModalEditarCliente = ({ isOpen, onClose, onSubmit, editingClient, handleEditInputChange, tipoClientes }) => {
                            ...
                            <form onSubmit={onSubmit}>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <input
                                        ...
                                        value={editingClient.emailCliente}
                                        onChange={handleEditInputChange}
                                        className="input-class m-4 text-[#757575]"
                                    />
                                    <input
                                    ...
                                    <input
                                        ...
                                        value={editingClient.direccionCliente}
                                        onChange={handleEditInputChange}
                                        className="input-class m-4 text-[#757575]"
                                    />
                                    <select
                                        name="tipoCliente"
                                        value={editingClient.tipoCliente}
                                        onChange={handleEditInputChange}
                                    >
