...
const BentoGrid = ({ correoUsuario }) => {
    return (
        <MenuPrincipal correoUsuario={correoUsuario} titulo={"MENÚ PRINCIPAL"} subtitulo={"Ingresa rápidamente a los datos guardados en Proofimaster"} >
            <div className="grid grid-cols-12 grid-rows-4 gap-4 mt-8 ">
                <div className="bentoItem col-span-4 row-span-2">
                ...
                <div className="bentoItem col-span-4 row-span-2">Total de ventas</div>
                <div className="bentoItem col-span-2 row-span-2 !bg-yellow-400">Alertas de stock</div>
                <div className="bentoItem col-span-2">Proveedores</div>
                <div className="bentoItem col-span-2">Clientes frecuentes</div>
                <div className="bentoItem col-span-8 row-span-2 !bg-sky-200">Informes generados</div>
                <div className="bentoItem col-span-4 row-span-1">Usuarios activos</div>
            </div>
        </MenuPrincipal>
    );
}
